...
ThisBuild / scmInfo := Some(
       ScmInfo(
          url("https://github.com/rssh/shim--scala-async--dotty-cps-async"),
          "scm:git@github.com:rssh/shim--scala-async--dotty-cps-async.git"
       )
)
...
ThisBuild / homepage := Some(url("https://github.com/rssh/shim--scala-async--dotty-cps-async"))
